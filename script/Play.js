...
playState.prototype = {
  ...
  update: function () {
    ...
    this.physics.arcade.collide(
      this.jolly.player,
      this.fruits.coconutGroup,
      this.coconutVsPlayer,
      null,
      this
  ...
  playerVsFruits: function (player, fruit) {
    fruit.kill();
    if (game.global.soundPlay) this.fruits.fruitSound.play();
    else this.fruits.fruitSound.stop();
  ...
  playerVsPlatform: function () {
    if (game.global.soundPlay) game.global.jumpSound.play();
    else game.global.jumpSound.stop();
  ...
  gemsVsPlayer: function (player, gems) {
    if (game.global.soundPlay) game.global.gemSound.play();
    else game.global.gemSound.stop();
